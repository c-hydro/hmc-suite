...
def select_namelist_type(namelist_type: str = 'hmc'):
    # select namelist type and structure
    if namelist_type == 'hmc':
        type_namelist = type_namelist_default_hmc
        structure_namelist = structure_namelist_default_hmc
    elif namelist_type == 's3m':
        type_namelist = type_namelist_default_hmc
        structure_namelist = structure_namelist_default_hmc
    else:
        log_stream.error(' ===> Namelist type "' + namelist_type + '" is not allowed')
